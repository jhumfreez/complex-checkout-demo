...
export class DealOptionComponent implements OnInit {
  ...
  @Output() onTaxIdChange: EventEmitter<string> = new EventEmitter();

  // TODO: Replace with something more commmon
  // Backup option: [-.\d]+
  ...
  taxIdChange(){
    ...
    this.onTaxIdChange.emit(this.myForm.controls.taxId.value);
  }
}
